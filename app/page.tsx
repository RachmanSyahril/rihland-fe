  ...
  const premiumVideos = [
    {
      ...
      duration: "25:30",
      thumbnail: "bg-gradient-to-br from-blue-600 to-purple-700",
    },
    {
      title: "Exclusive Expert Interviews",
      duration: "18:45",
      thumbnail: "bg-gradient-to-br from-purple-600 to-blue-700",
    },
    {
      title: "In-Depth Case Studies",
      duration: "32:15",
      thumbnail: "bg-gradient-to-br from-blue-700 to-indigo-800",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        ></div>
        <div
          className="absolute top-40 left-1/2 w-80 h-80 bg-indigo-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse"
      ...
      <nav className="fixed top-0 w-full z-50 backdrop-blur-sm bg-slate-900/80 border-b border-blue-500/20 transition-all duration-300">
        ...
        <div
          ...
          } overflow-hidden bg-slate-900/90 backdrop-blur-sm`}
        >
      ...
      <section
        id="home"
        className="relative z-10 px-6 py-32 min-h-screen flex items-center"
      >
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto animate-in slide-in-from-bottom-4 duration-1000 delay-200">
            Educational Content with depth, clarity, and Islamic Worldview
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="space-y-6">
              <p className="text-lg text-gray-300 leading-relaxed">
                Rihland is a video production studio committed to delivering
                educational content. Our mission is to spread knowledge and
                ideas, offering explanations and insights through an Islamic
                lens. We excel at breaking down complex topics in an accessible
                and comprehensive manner. Our videos, grounded in thorough
                research, use vibrant and engaging animations to effectively
                communicate impactful messages.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed">
                Founded by Muhammad Fahd Al Antaroh in 2017 in Turkey. Rihland
                is a platform dedicated to uncovering and sharing untold Islamic
                stories, from history, culture, and theology, to the modern
                struggles that shape our world. Through compelling animations
                and carefully researched content, we challenge distorted
                narratives, bridge communities, and bring forgotten truths to
                light.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed">
                What We Are Doing?
              ...
              <p className="text-lg text-gray-300 leading-relaxed">
                History and knowledge, when viewed through an authentic Islamic
                lens, reveal unified truths that connect us to our heritage.”
                And this isn’t just what we believe at Rihland.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed">
                Our Approach
              </p>
              <ol>
                <li>
                  Research Integrity: Every documentary begins with thorough,
                  academically sound research that honors historical accuracy.
                </li>
                <li>
                  Visual Storytelling: Complex ideas are transformed into
                  vibrant animations that capture attention and enhance
                  understanding.
                </li>
                <li>
                  Educational Focus: Our content prioritizes learning outcomes,
                  breaking down difficult concepts into digestible segments.
                </li>
                <li>
                  Community Unity: We highlight stories and knowledge that
                  strengthen our shared identity rather than dividing
                  communities.
                </li>
                <li>
                  Narrative Reclamation: We actively work to correct
                  misrepresentations and fill gaps in mainstream media
                  portrayals.
                </li>
              </ol>
            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-sm border border-blue-400/30 rounded-2xl p-8">
                ...
                <p className="text-gray-300 leading-relaxed">
                  To create a world where technology serves humanity, where
                  innovation drives sustainability, and where every individual
              ...
              {freeVideos.map((video, index) => (
                ...
                >
                  <div className="relative overflow-hidden rounded-xl">
                    <div
                      className={`w-full h-48 ${video.thumbnail} flex items-center justify-center`}
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {premiumVideos.map((video, index) => (
                ...
                >
                  <div className="relative overflow-hidden rounded-xl">
                    <div
                      className={`w-full h-56 ${video.thumbnail} flex items-center justify-center`}
                    >
            ...
            <div className="flex flex-col justify-center">
              <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-sm border border-blue-400/30 rounded-2xl p-8">
                ...
                <p className="text-gray-300 mb-8 leading-relaxed">
                  ...
                  support our community, and expand our reach to help more
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-12">
            <p className="text-gray-300 text-lg mb-8">
              Trusted by leading organizations worldwide. Join our network of
              partners.
            </p>
      ...
      <footer
        id="footer"
        className="relative z-10 px-6 py-20 bg-slate-900/50 backdrop-blur-sm border-t border-blue-500/20"
      >
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                Empowering change through innovation and collaboration. Join us
          ...
          <div className="border-t border-blue-500/20 pt-8 text-center text-gray-400">
            <p>&copy; 2025 Rihland. All rights reserved.</p>
          </div>
        </div>
      </footer>
